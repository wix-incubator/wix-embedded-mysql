...
public class MysqldConfigBuilder {
    ...
    private String schema = Defaults.SCHEMA;
    ...
    public MysqldConfigBuilder withSchema(String schemaName) { this.schema = schemaName; return this; }
    public MysqldConfigBuilder withPort(int port) { this.port = port; return this; }

    public MysqldConfig build() { return new MysqldConfig(version, username, password, schema, port); }
}
