...
final class ProcessRunner {
    ...
    static void run(Process p, IRuntimeConfig runtimeConfig, int timeoutSec) throws IOException {
        ...
        try {
            ...
            int retCode = TimingOutProcessExecutor.waitFor(p, timeoutSec, TimeUnit.SECONDS);
